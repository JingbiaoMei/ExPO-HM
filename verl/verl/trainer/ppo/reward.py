...
def load_reward_manager(config: DictConfig, tokenizer: Any, **reward_kwargs: Any) -> RewardManagerBase:
    ...
    if compute_score is None:
        # Keep parity with legacy PPO behavior: reward_model.reward_kwargs should
        # be forwarded to default rule-based reward scoring.
        reward_model_kwargs = dict(config.reward_model.get("reward_kwargs", {}))
        ...
        if sandbox_url:
            ...
            final_compute_score = partial(default_compute_score, **reward_model_kwargs)
