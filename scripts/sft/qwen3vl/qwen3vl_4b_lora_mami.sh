...
llamafactory-cli train scripts/sft/qwen3vl/qwen3vl_4b_lora_mami.yaml


python eval/inference/qwen2_hm_inference_vllm.py \
    --base_model_path "Qwen/Qwen3-VL-4B-Instruct" \
    --model_path "checkpoints/mami/qwen3_vl_4b" \
    --processor_path "Qwen/Qwen3-VL-4B-Instruct" \
    --data_split "val test" \
    --dataset "MAMI" \
    --batch_size 1000 \
    --log_name "qwen3vl_4b_lora_sft_warmup_fg_choice_mami"
