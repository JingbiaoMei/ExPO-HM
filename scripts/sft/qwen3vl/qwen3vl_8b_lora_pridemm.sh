...
llamafactory-cli train scripts/sft/qwen3vl/qwen3vl_8b_lora_pridemm.yaml


python eval/inference/qwen2_hm_inference_vllm.py \
    --base_model_path "Qwen/Qwen3-VL-8B-Instruct" \
    --model_path "checkpoints/pridemm/qwen3_vl_8b" \
    --processor_path "Qwen/Qwen3-VL-8B-Instruct" \
    --data_split "val test" \
    --dataset "PrideMM" \
    --batch_size 1000 \
    --log_name "qwen3vl_8b_lora_sft_warmup_fg_choice_pridemm"
